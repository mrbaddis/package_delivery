...
export class PushNotificationApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public subscribe(subscription: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public sendNotificationToUser(userId: any, notification: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/PushNotifications/send-notification-to-user/:userId";
    let _routeParams: any = {
      userId: userId
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public sendNotificationToAllUsers(courierId: any, notification: any, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
